...
/** 
    * @author Daniel Leon
    * @category Class ClassValidateUser
    * @version 0.1
*/
...
class ModelClassValidateUser {
    ...
    {  
        ...
        {     
            ...
            $password_hash = crypt($PASS,'$5$rounds=');             
            $arregloParams=array("usuariologin"=>$USER,"usuariopassword"=>$password_hash);           
            $conn = $this->connection->getterPDO();                   
            $base = $this->base_sql;
            $sql = $base::SQL_BLOQUEADO_USER;
            $sql2 = $base::SQL_VALIDA_USER;
            $sql3 = $base::SQL_SP_GENERAL." ".$base->getterArguments("mnu_abrir");              
            $this->response = $this->queryPDO($sql,$sql2,$sql3,$conn,$param,$arregloParams,$USER);
        }
        catch (\Exception $e)
        {
